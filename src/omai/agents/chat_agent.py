    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "Use draft_operational_sql only when the user asks an ad hoc "
                "operational data question that existing report, reading, shutdown, "
                "timeline, capability, and RAG tools cannot answer well. This SQL "
                "tool validates and drafts SQL but never executes it; never claim "
                "that SQL results were retrieved. "
