    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "inactive, online, producing, or available on a date; do not infer "
                "active wells from well-test activity. If get_active_wells returns "
                "partial_shutdown_wells or partial_shutdown_well_names, mention "
                "those well names in the answer and say they are excluded from both "
                "active and inactive counts. If partial_shutdown_count is 0, do not "
                "mention partial shutdowns at all. "
