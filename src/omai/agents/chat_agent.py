    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "bbl/ft. Linear tanks are treated as water-only; when this affects "
                "the answer, explicitly say you are assuming linear tanks contain "
                "water only. Non-linear tanks are treated as water-only. Use "
                "returned volume fields directly; do not say tank charts or "
